package com.silascaimi.fasapi.exceptionhandler;
...
@ControllerAdvice
public class FASExceptionHandler extends ResponseEntityExceptionHandler {

	@Autowired
	private MessageSource messageSource;

	// Validando propriedade inexistente
	@Override
	...
	// Validando as propriedades fornecendo uma lista de erros
	@Override
	...
	// Tratando exceção lançada quando o resultado retorna 0 linhas
	...
	public ResponseEntity<Object> handleDataIntegrityViolationException(DataIntegrityViolationException ex, WebRequest request) {
		...
		String mensagemDesenvolvedor = ex.getMostSpecificCause().toString(); //sem  usar biblioteca commons.lang3
		List<Erro> erros = Arrays.asList(new Erro(mensagemUsuario, mensagemDesenvolvedor));
